...
export default function WeekStrip({ days, activeDate }) {
  return (
    <div className="bg-surface border-b border-lborder px-6 py-3 flex gap-2 overflow-x-auto">
      {days.map((d) => {
        ...
        return (
          <div
            key={d.date}
            className={`flex-1 min-w-[72px] flex flex-col items-center gap-1 px-2 py-2 rounded-lg border text-center
              ${isActive ? 'bg-cerulean-light border-cerulean' : 'border-transparent'}`}
          >
